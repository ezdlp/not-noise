    ...
    <section className="py-20 px-4 bg-cta-gradient">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <CTAButton 
          ...
          className="bg-white text-toreaBay hover:bg-snowyMint hover:text-persianBlue transition-all duration-300 transform hover:scale-105 hover:animate-glow font-bold"
        >
