...
const features = [
  ...
  },
  {
    ...
    gradient: "from-[#000046] to-[#1CB5E0]",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className="group relative rounded-xl overflow-hidden hover:-translate-y-1 transition-all duration-300 h-[400px]"
            >
              {/* Gradient Background */}
              ...
              <div className="relative p-8 h-full flex flex-col">
                {/* Icon Container - Black Shape */}
                <div className="mb-6 relative">
                  <svg width="80" height="80" viewBox="0 0 80 80" className="transform rotate-45">
                    <path d="M40 0L80 40L40 80L0 40L40 0Z" fill="black" />
                  </svg>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <feature.icon className="h-8 w-8 text-white transform -rotate-45" />
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-white/90 leading-relaxed font-sans">{feature.description}</p>
                </div>
