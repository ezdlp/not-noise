...
type LogoColor = "primary" | "dark" | "light" | "white";

interface SoundraiserLogoProps {
  variant?: LogoVariant;
  className?: string;
  width?: number | string;
...
const colorMap: Record<LogoColor, string> = {
  primary: "#6851FB", // Majorelle Blue
  dark: "#271153",    // Deep Majorelle Blue
  light: "#D0C7FF",   // Light pastel blue
  white: "#FFFFFF"    // White
};

export function SoundraiserLogo({
  variant = "A",
  className = "",
  width = 40,
  height = 28,
  color = "primary"
}: SoundraiserLogoProps) {
  ...
  return (
    <svg
      width={width}
      height={height}
      viewBox="0 0 416.56 291.46"
      className={className}
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
        fill={fillColor}
        d="M63.41,165.42c-9.69-12.65-14.74-27.14-14.39-43.03c0.62-27.61,13.11-48.69,36.76-62.97
