-- Create a new analytics function with a different name
CREATE OR REPLACE FUNCTION get_dummy_analytics_stats(
...
GRANT EXECUTE ON FUNCTION get_dummy_analytics_stats TO authenticated; 