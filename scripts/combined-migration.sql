-- Combined SQL migrations for fixing subscription issues

-- 1. Create a function to get users with multiple active subscriptions
...
-- 2. Create a function to handle subscription updates properly
...
-- 3. Create active subscriptions view
