-- Create a simpler, more performant version of the analytics function
-- This version focuses on pure performance with minimal complexity
...
-- First, create a simplified version with a new name to avoid conflicts
CREATE OR REPLACE FUNCTION get_analytics_stats_v2(
...
GRANT EXECUTE ON FUNCTION get_analytics_stats_v2(TIMESTAMP WITH TIME ZONE, TIMESTAMP WITH TIME ZONE) TO authenticated; 