...
console.log('Smart Link Preview Edge Function: Initializing');
...
<head>
  ...
  <!-- Music Specific Tags -->
  <meta property="music:musician" content="ARTIST_NAME_PLACEHOLDER">
  <meta property="music:creator" content="ARTIST_NAME_PLACEHOLDER">
  <meta property="music:musician:url" content="ARTIST_MUSICIAN_URL_PLACEHOLDER">
  ...
  <!-- No redirect for crawlers to ensure they read all meta tags -->
  <script>
    // Only redirect actual users, not crawlers
    if (!/bot|crawler|spider|pinterest|facebook|twitter|linkedin|vkontakte|slack|discord|Bot|facebookexternalhit|Facebot|Twitterbot|WhatsApp|TelegramBot|LinkedInBot|PinterestBot|Slackbot|DiscordBot|Discordbot/i.test(navigator.userAgent)) {
...
Deno.serve(async (req) => {
  ...
  const responseHeaders = {
    ...
    'X-Smart-Link-Bot-Detected': 'true',
    'X-Smart-Link-Version': '1.1',
    'X-Smart-Link-Generator': 'supabase-edge-function'
  };
  ...
  try {
    ...
    let html = HTML_TEMPLATE
      ...
      .replace(/ARTIST_NAME_PLACEHOLDER/g, escapeHtml(smartLink.artist_name))
